        ...
        <div className={styles.valuesGrid}>
          <div className={styles.valuesItem}>
            ...
            <p className={styles.itemText}>
              Handpicked pieces inspired by city nights, neon signs, and
              sidewalk culture.
            </p>
          </div>
          <div className={styles.valuesItem}>
            ...
            <p className={styles.itemText}>
              Premium materials and limited runs — made to be worn, not
              collected.
            </p>
          </div>
          <div className={styles.valuesItem}>
            ...
            <p className={styles.itemText}>
              Designed to layer, move, and hold up to real city life.
            </p>
          </div>
        </div>
      </div>
